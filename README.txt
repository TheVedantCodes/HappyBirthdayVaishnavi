...
V5 CAKE + BUTTON UPDATES
- Pink primary buttons now have stronger contrast, a soft glow, gradient, and white edge so they do not disappear into a light-pink background.
- The cake now has a more top-down/camera-like perspective, layered shading, a visible cut seam, and a cake slice that pulls away after cutting.
- The cake top says "Vaishnavi".
- Cake celebration sound is customizable in script.js under CONFIG.cakeSound.

Cake sound setup:
  cakeSound: {
    src: "Assets/cake-cut.mp3",
    volume: 0.78,
